...
<div on:mousedown data-card-detail={timeslot.appointment === undefined ? 'woepie' : timeslot.appointment.id} class="appointment cursor-pointer" id={timeslot.timeslotId}>
